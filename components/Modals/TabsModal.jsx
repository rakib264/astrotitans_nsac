      ...
      <div className="panel border-[2px] rounded-md p-3">
        <div className="mb-5 flex items-center justify-between">
          <h5 className="text-lg font-semibold text-black">
            TabsModal Animation Style Modal
          </h5>
        </div>
        {/* TabsModal */}
        <div className="mb-4">
            ...
            <Dialog as="div" open={modal18} onClose={() => setModal18(false)}>
              ...
              >
                <div className="flex min-h-screen items-start justify-center px-4">
                  ...
                  >
                    <Dialog.Panel className="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black ">
                      ...
                      <div className="p-5 bg-[#fbfbfb]">
                        <Tab.Group>
                          <Tab.List className="mt-3 flex flex-wrap border-b border-white-light ">
                            ...
                            <Tab className="pointer-events-none -mb-[1px] block p-3.5 py-2 text-white-light outline-none ">
                              Disabled
                            </Tab>
                          </Tab.List>
                                ...
                                <div className="flex items-start pt-5">
                                  <div className="h-20 w-20 flex-none ltr:mr-4 rtl:ml-4">
                                    <img
                                      ...
                                      alt="img"
                                      className="m-0 h-20 w-20 rounded-full object-cover ring-2 ring-[#ebedf2] "
                                    />
                                  </div>
                                  <div className="flex-auto">
                                    ...
                                    <p className="text-white-dark">
                                      ...
                                      sollicitudin. Cras purus odio, vestibulum
