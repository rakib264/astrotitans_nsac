      ...
      <div className="panel border-[2px] rounded-md p-3">
        <div className="mb-5 flex items-center justify-between">
          <h5 className="text-lg font-semibold text-black">
            FardeIn Down Animation Style Modal
          </h5>
        </div>
        <div className="mb-5">
        <button
            ...
            <Dialog as="div" open={modal9} onClose={() => setModal9(false)}>
              ...
              >
                <div className="flex min-h-screen items-start justify-center px-4">
                  <Dialog.Panel className="panel animate__animated animate__fadeIn my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black">
