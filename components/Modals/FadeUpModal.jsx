      ...
      <div className="panel border-[2px] rounded-md p-3">
        <div className="mb-5 flex items-center justify-between">
          <h5 className="text-lg font-semibold text-black">
            FardeInUp Animation Style Modal
          </h5>
        </div>
        {/* FadeIn Up */}
        <div className="mb-4">
            ...
            <Dialog as="div" open={modal11} onClose={() => setModal11(false)}>
              ...
              >
                <div className="flex min-h-screen items-start justify-center px-4">
                  <Dialog.Panel className="panel animate__animated animate__fadeInUp my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black ">
