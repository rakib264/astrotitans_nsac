            ...
            <Dialog as="div" open={modal19} onClose={() => setModal19(false)}>
              ...
              >
                <div className="flex min-h-screen items-start justify-center px-4">
                  ...
                  >
                    <Dialog.Panel className="panel my-8 w-full max-w-[300px] overflow-hidden rounded-lg border-0 bg-secondary p-0 text-black">
                      <div className="flex items-center justify-end pt-4 text-white ltr:pr-4 rtl:pl-4 ">
                        <button
                          onClick={() => setModal19(false)}
                          type="button"
                          className="text-white-dark hover:text-dark pr-3"
                        >
                          <svg
