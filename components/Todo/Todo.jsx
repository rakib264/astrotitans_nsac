...
const Todolist = () => {
  ...
  const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('Manage Todo'));
    });
  ...
  const searchTasks = (isResetPage = true) => {
    ...
    setFilteredTasks([
      ...res.filter((d) => d.title?.toLowerCase().includes(searchTask)),
    ]);
              ...
              <div className="space-y-1">
                ...
                >
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-3 w-3 shrink-0 rotate-45 fill-success"
                  >
                    <path
                        ...
                        >
                          ...
                          <td>
                            <div onClick={() => viewTask(task)}>
                              ...
                              <div
                                className={`min-w-[300px] overflow-hidden text-white-dark line-clamp-1 ${
                                  task.status === "complete"
                                    ? "line-through"
                                    : ""
                                }`}
                                    ...
                                    {selectedTab !== "trash" && (
                                      <>
                                        <li>
                                          ...
                                          >
                                            <svg
                                              ...
                                              fill="none"
                                              xmlns="http://www.w3.org/2000/svg"
                                              className="h-4.5 w-4.5 shrink-0 mr-2"
                                            >
                                              <path
                                                opacity="0.5"
                                                d="M4 22H20"
                                        ...
                                        <li>
                                          ...
                                          >
                                            <svg
                                              className="h-5 w-5 shrink-0 mr-2 dark:text-gray-400 dark:group-hover:text-white"
                                              width="20"
                                              height="20"
                                              viewBox="0 0 24 24"
                                              fill="none"
