      ...
      <div>
        ...
        <div className="mb-6 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          <div className="panel h-full pb-0 sm:col-span-2 xl:col-span-1">
            ...
            <PerfectScrollbar
              className={`relative h-[290px] overflow-hidden transition-max-h hover:overflow-y-scroll`}
            ...
            >
              <div className="cursor-pointer text-sm">
                <div className="group relative flex items-center py-1.5">
                  ...
                  <div className="text-xs text-white-dark ml-auto dark:text-gray-500">
                    Just Now
                  </div>

                  <span className="badge badge-outline-primary absolute bg-primary-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    Pending
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-success mr-1"></div>
                  <div className="flex-1">Send Mail to HR and Admin</div>
                  <div className="text-xs text-white-dark ml-auto dark:text-gray-500">
                    2 min ago
                  </div>

                  <span className="badge badge-outline-success absolute bg-success-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    Completed
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-danger mr-1"></div>
                  <div className="flex-1">Backup Files EOD</div>
                  <div className="text-xs text-white-dark ml-auto dark:text-gray-500">
                    14:00
                  </div>

                  <span className="badge badge-outline-danger absolute bg-danger-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    Pending
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-black mr-1"></div>
                  <div className="flex-1">Collect documents from Sara</div>
                  <div className="text-xs text-white-dark ml-auto dark:text-gray-500">
                    16:00
                  </div>

                  <span className="badge badge-outline-dark absolute bg-dark-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    Completed
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-warning mr-1"></div>
                  <div className="flex-1">
                  ...
                  <span className="badge badge-outline-warning absolute bg-warning-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    In progress
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-info mr-1"></div>
                  <div className="flex-1">Rebooted Server</div>
                  <div className="text-xs text-white-dark ml-auto dark:text-gray-500">
                    17:00
                  </div>

                  <span className="badge badge-outline-info absolute bg-info-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    Completed
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
                  <div className="h-1.5 w-1.5 rounded-full bg-secondary mr-1"></div>
                  <div className="flex-1">
                  ...
                  <span className="badge badge-outline-secondary absolute bg-secondary-light text-xs opacity-0 group-hover:opacity-100 right-0 dark:bg-black">
                    Pending
                  </span>
                </div>
                <div className="group relative flex items-center py-1.5">
            ...
            <div className="border-t border-white-light dark:border-white/10">
              ...
              >
                View All
                <svg
                  className="h-4 w-4 transition duration-300 group-hover:translate-x-1 ml-1 rtl:rotate-180 rtl:group-hover:-translate-x-1"
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="panel h-full overflow-hidden border-0 p-0">
            <div className="min-h-[190px] bg-gradient-to-r from-[#4361ee] to-[#160f6b] p-6">
              <div className="mb-6 flex items-center justify-between">
                <div className="flex items-center rounded-full bg-black/50 p-1 font-semibold text-white pr-3">
                  <img
                    className="block h-8 w-8 rounded-full border-2 border-white/50 object-cover mr-1"
                ...
                <tbody>
                  <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                    ...
                    <td>
                      ...
                      >
                        <svg
                          className="h-3.5 w-3.5 mr-1 rtl:rotate-180"
                          viewBox="0 0 24 24"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                        >
      ...
      <div className="mt-6">
        <div className="mb-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="panel h-full">
            ...
            <div className=" my-10 text-3xl font-bold text-[#e95f2b]">
              <span>$ 45,141 </span>
              <span className="text-sm text-black mr-2 dark:text-white-light">
                this week
              </span>
              <svg
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="ml-5 dark:text-white-light">
                57%
              </span>
            </div>
          </div>
        ...
        <div className="mb-6 grid gap-6 lg:grid-cols-3">
          ...
          <div className="panel h-full">
            ...
            <PerfectScrollbar className="perfect-scrollbar relative h-[360px] mx-3 overflow-hidden hover:overflow-y-scroll">
              <div className="space-y-7">
                <div className="flex">
                  <div className="relative z-10 shrink-0 before:absolute before:top-10 before:left-4 before:h-[calc(100%-24px)] before:w-[2px] before:bg-white-dark/30 mr-2">
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          <div className="panel h-full">
            <div className="-m-5 mb-5 flex  items-start border-b border-white-light p-5 dark:border-[#1b2e4b]">
              <div className="shrink-0 rounded-full ring-2 ring-white-light mr-4 dark:ring-dark">
                <img
              ...
              <div className="absolute bottom-0 -mx-5 flex w-full items-center justify-between p-5">
                <div className="flex items-center">
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="relative -top-1 inline text-info mr-1.5"
                  >
                    <path
                ...
                >
                  ...
                  <svg
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 ml-1.5 rtl:rotate-180"
                  >
                    <path
                      d="M11 19L17 12L11 5"
                      stroke="currentColor"
          ...
          <div className="panel h-full">
            <div className="-m-5 mb-5 flex items-center justify-between border-b border-white-light p-5 dark:border-[#1b2e4b]">
              <button type="button" className="flex font-semibold">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-secondary text-white mr-4">
                  <span>FD</span>
                </div>
            ...
            <div className="group">
              ...
              <div className="mb-2 flex items-center justify-between font-semibold">
                <div className="flex items-center">
                  ...
                  <div className="text-xs ml-2">5 Tasks</div>
                </div>
