                ...
                {swap.map((item) => {
                  return (
                    <li key={item.id} className=" cursor-grab">
                      <div className="items-md-center flex flex-col rounded-md border border-white-light bg-white px-6 py-3.5 md:text-left dark:border-dark dark:bg-[#1b2e4b] md:flex-row">
                        <div className="mr-4">
                          <img
                            alt="avatar"
