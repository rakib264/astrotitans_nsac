      ...
      <div className="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                ...
                <div className="panel" id="icons">
                    ...
                    <div className="mb-5">
                        <div className="flex flex-wrap items-center justify-center gap-2">
                            <button type="button" className="btn btn-primary">
                                <svg className="shrink-0 pr-1.5" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button type="button" className="btn btn-warning rounded-full">
                                Right
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0 pl-1.5">
                                    <path
