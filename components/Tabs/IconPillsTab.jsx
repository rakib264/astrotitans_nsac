    ...
    <ClientOnly>
      <div className="bg-white px-10 py-8 h-auto">
        ...
        <div className="mb-5 flex items-center justify-between">
          <h5 className="text-lg font-semibold text-black">Icon Pills</h5>
        </div>
        <div className="mb-5">
          <Tab.Group>
                  ...
                  <button
                    className={`${
                      selected ? "bg-warning text-white !outline-none" : ""
                                                    ...
                                                    -mb-[1px] flex items-center gap-2 rounded p-3.5 py-2 before:inline-block hover:bg-warning hover:text-white`}
                  >
                    <svg
                      width="24"
                      height="24"
