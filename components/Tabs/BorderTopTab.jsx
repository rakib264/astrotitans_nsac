              ...
              <Tab as={Fragment}>
                {({ selected }) => (
                  <button
                    className={`${
                      selected
                        ? "!border-secondary text-secondary !outline-none"
                        : ""
                    }
                                                    ' flex items-center gap-2 border-t-2 border-transparent bg-[#f6f7f8] p-7 py-3 before:inline-block hover:border-secondary hover:text-secondary`}
                  >
                    <svg
                      width="24"
                      height="24"
              ...
              <Tab.Panel>
                <div>
                  <div className="flex items-start pt-5">
                    <div className="h-20 w-20 flex-none mx-2">
                      <img
