...
const CarouselCardWithCustomShadow = () => {
  ...
  return (
    ...
    onMouseOver={() => setMouseOver(true)} 
      onMouseOut={() => setMouseOver(false)}
    className="panel shadow-info 'w-full sm:w-[400px] h-[510px] bg-white dark:bg-black rounded-md">
      ...
      <div className="pt-6 pb-4 px-4 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="text-lg font-semibold text-black dark:text-gray-200">Forde, Norway</div>
        ...
        <div className="text-gray-400 text-sm font-light">
          Relax, rejuvenate and unplug in this unique contemporary Birdbox. Feel close to nature in ultimate comfort. Enjoy the view of the epic mountain range of Blegja and the Førdefjord and too good.
          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-0">
              <span className="text-black text-xl font-semibold dark:text-white">$397</span>
              <span className="text-gray-400 font-light dark:textgray-500 pl-1">/ night</span>
            </div>
...
export default CarouselCardWithCustomShadow;
